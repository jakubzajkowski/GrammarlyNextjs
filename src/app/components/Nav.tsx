    ...
    return <div className={styles.navbar}>
        <div className={styles.nav}>
            <div className={styles.nav__left}>
                ...
                <p className={styles.nav__option}><Link className={styles.link__style__black} href="/why-grammarly">Why Grammarly</Link></p>    
                <p className={styles.nav__option}><Link className={styles.link__style__black} href="/for-work">For Work</Link></p>
                <p className={styles.nav__option}><Link className={styles.link__style__black} href="/for-education">For Education</Link></p>
                <p className={styles.nav__option}><Link className={styles.link__style__black} href="/compare-plans">Compare Plans</Link></p>
            </div>
        ...
        {isMobileBar && (
            <motion.div className={styles.nav__mobile__container} initial={{ left: '0%' }} animate={{ left: ['100%','0%'] }} exit={{ left: ['0%','100%'] }}>
                ...
                <div className={styles.nav__mobile__options}>
                    <p className={styles.nav__mobile__option}><Link className={styles.link__style__black} href="/why-grammarly">Why Grammarly</Link></p>    
                    <p className={styles.nav__mobile__option}><Link className={styles.link__style__black} href="/for-work">For Work</Link></p>
                    <p className={styles.nav__mobile__option}><Link className={styles.link__style__black} href="/for-education">For Education</Link></p>
                    <p className={styles.nav__mobile__option}><Link className={styles.link__style__black} href="/compare-plans">Compare Plans</Link></p>
                    <p className={styles.nav__mobile__register}><Link className={styles.link__style__white} href="/register">Get Grammarly</Link></p>
                    <p className={styles.nav__mobile__login}><Link className={styles.link__style__color} href="/login">Log in</Link></p>
                </div>
            </motion.div>
        )}
  </AnimatePresence>
