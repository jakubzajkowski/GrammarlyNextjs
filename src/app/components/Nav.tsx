    ...
    return <>
        <div className={styles.nav}>
            <div className={styles.nav__left}>
                ...
                <p className={styles.nav__option}><Link className={vars.link__style__black} href="/">Why Grammarly</Link></p>    
                <p className={styles.nav__option}><Link className={vars.link__style__black} href="/">For Work</Link></p>
                <p className={styles.nav__option}><Link className={vars.link__style__black} href="/">For Education</Link></p>
                <p className={styles.nav__option}><Link className={vars.link__style__black} href="/">Compare Plans</Link></p>
            </div>
            <div className={styles.nav__right}>
                <p className={styles.nav__signup}><Link className={vars.link__style__black} href="/">Log in</Link></p>
                <p className={styles.nav__register}><Link className={vars.link__style__white} href="/">Get Grammarly it's free</Link></p>
        ...
        {isMobileBar && (
            <motion.div className={styles.nav__mobile__container} initial={{ left: '0%' }} animate={{ left: ['100%','0%'] }} exit={{ left: ['0%','100%'] }}>
                ...
                <div className={styles.nav__mobile__options}>
                    <p className={styles.nav__mobile__option}><Link className={vars.link__style__black} href="/">Why Grammarly</Link></p>    
                    <p className={styles.nav__mobile__option}><Link className={vars.link__style__black} href="/">For Work</Link></p>
                    <p className={styles.nav__mobile__option}><Link className={vars.link__style__black} href="/">For Education</Link></p>
                    <p className={styles.nav__mobile__option}><Link className={vars.link__style__black} href="/">Compare Plans</Link></p>
                    <p className={styles.nav__mobile__register}><Link className={vars.link__style__white} href="/">Get Grammarly</Link></p>
                    <p className={styles.nav__mobile__login}><Link className={vars.link__style__color} href="/">Log in</Link></p>
                </div>
            </motion.div>
        )}
  </AnimatePresence>
